      ...
      <main className="relative z-10 text-center">
        <GlassCard className="animate-float relative">
          ...
          <button
            ...
            className="absolute top-4 right-4 dark:text-white/50 hover:text-white transition-colors text-black"
          ...
          <div className="mb-6">
            <span className="inline-block p-4 bg-white/20 rounded-2xl border border-white/30">
              ...
              >
                <path
                  d="M9 12.75L11.25 15L15 9.75M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C14.341 3 16.4839 4.02237 18 5.5"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
          ...
          <p className="text-slate-800 mb-8 max-w-md mx-auto dark:text-white/80">
            با پاسخ به چند سوال ساده، سبک یادگیری خودت را بشناس و مسیر موفقیتت
            را سریع‌تر پیدا کن.
          </p>
          <Button variant="primary-glass" size="lg" onClick={onStartQuiz}>
            شروع آزمون
          </Button>
        </GlassCard>
      </main>
